...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--historical-lock-start-date",
        default="2025-01-01",
        help="Payouts before this date are treated as already filed historical context.",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    output_paths = run_workflow(
        ...
        historical_lock_start_date=date.fromisoformat(args.historical_lock_start_date),
