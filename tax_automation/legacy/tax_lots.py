"""Legacy FIFO lot utilities kept only for historical/reference use.

The active stock path uses moving-average state in `src.moving_average`.
Only legacy FIFO/lot workflows should depend on this module.
"""
